 ...
 */
catchy.captureError = function (error) {
    ...
    if (Helpers.isBrowser()) {
        ...
        var logName = 'catchy-' + Helpers.getLocaleISODate('date');
        ...
        var folderPath = catchy.opts.writeFile.folderPath;
